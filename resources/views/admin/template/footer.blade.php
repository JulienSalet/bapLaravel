...
{{--<span class="font-montserrat">WebL'Agence</span>.--}}
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content-wrapper">
                <div class="modal-content">
                    ...
                    <form action="{{ action('Admin\AccountController@store', request()->user()->id) }}" method="post">
                        {{ csrf_field() }}
                        {{ method_field('put') }}
...
<script src="{{ asset('pages-assets/plugins/datatables-responsive/js/datatables.responsive.js') }}" type="text/javascript"></script>
...
<script src="{{ asset('pages-assets/plugins/jquery-nouislider/jquery.nouislider.min.js') }}" type="text/javascript"></script>
<script src="{{ asset('pages-assets/plugins/jquery-nouislider/jquery.liblink.js') }}" type="text/javascript"></script>
<script src="{{ asset('pages-assets/plugins/bootstrap-tag/bootstrap-tagsinput.min.js') }}" type="text/javascript"></script>
<script type="text/javascript" src="{{ asset('pages-assets/plugins/boostrap-form-wizard/js/jquery.bootstrap.wizard.min.js') }}"></script>
