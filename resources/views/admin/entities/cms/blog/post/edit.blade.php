...
@section('content')
    <div class="content sm-gutter">
        <div class="container-fluid container-fixed-lg">
            ...
            <form action="{{ action('Admin\Cms\Blog\PostController@update', $post) }}" method="POST"
                ...
                <div class="row">
                        ...
                        <div class="card card-white">
                            <div class="card-header">
                                <div class="card-title">
                                    Modifier l'article <strong>{{ $post->title }}</strong>
                                </div>
                            </div>
                            <div class="card-block">
                                ...
                                <div class="row clearfix">
                                    <div class="col-md-6">
                                        <div class="form-group {{ $errors->has('file') ? 'has-error' : '' }} form-group-default"
                                             aria-required="true">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group {{ $errors->has('excerpt') ? 'has-error' : '' }} form-group-default required"
                                            ...
                                            <textarea type="text" class="form-control editor" name="excerpt"
                                                      placeholder="Description de l'article">{{ $post->excerpt }}</textarea>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group {{ $errors->has('content') ? 'has-error' : '' }} form-group-default required"
                                            ...
                                            <textarea type="text" class="form-control editor" name="content"
                                                      placeholder="Contenue de l'article">{{ $post->content }}</textarea>
                    ...
                    <div class="col-md-4">
                        <div class="card card-white">
                            ...
                            <div class="card-block">
                                <img src="{{ $post->getFile->file }}" width="300px" alt="">
                            </div>
                        </div>
