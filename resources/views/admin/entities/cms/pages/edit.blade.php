                    ...
                    <div class="col-xl-7 col-lg-6 ">
                        <div class="card card-white">
                            ...
                            <div class="card-block">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group {{ $errors->has('title') ? 'has-error' : '' }} form-group-default required"
                                            ...
                                            <input type="text" class="form-control" name="title"
                                                   value="{{ $page->title }}"
                                                   placeholder="{{ trans('admin/entities/cms/pages.title-page') }}"
                                                   required>
                                            @if ($errors->has('title'))
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group {{ $errors->has('description') ? 'has-error' : '' }} form-group-default required"
                                            ...
                                            <textarea type="text" class="form-control" name="description"
                                                      placeholder="Description de la page">{{ $page->content }}</textarea>
                                ...
                                {{--<label>Vue de la page</label>--}}
                                {{--<input type="text" class="form-control" name="view"--}}
                                {{--value="{{ $page->view }}"--}}
                                {{--placeholder="Vue de la page">--}}
                                {{--@if ($errors->has('view'))--}}
                                {{--<div class="help-block">--}}
                        ...
                        <div class="card card-transparent">
                            ...
                            <div class="card-block">
                                ...
                                <p>
                                    Lorem ipsum dolor sit amet, consectetur adipisicing elit. Animi delectus ea eum
                                    eveniet id inventore laborum necessitatibus, neque nulla sapiente sequi tenetur
                                    voluptatem voluptatibus? Accusantium enim error minus optio quis.
                                </p>
                                <br>
                                ...
                                <div class="row clearfix">
                                    <div class="form-group">
                                        ...
                                        <p class="link-seo" data-text="seo-url">
                                            {{ env('APP_URL') }}/nom-de-categorie/<span
                                                    data-text="seo-title">{{ $page->seo_title ? $page->seo_title : 'nom-de-page' }}</span>
                                        </p>
                                    ...
                                    <div class="form-group {{ $errors->has('seo_title') ? 'has-error' : '' }} form-group-default">
                                        <label>
                                            {{ trans('admin/entities/cms/pages.title-page') }}
                                ...
                                <div class="row clearfix">
                                    <div class="form-group">
                                        ...
                                        <p class="link-seo" data-text="og-url">
                                            {{ env('APP_URL') }}/nom-de-categorie/<span
                                                    data-text="og-title">{{ $page->og_title ? $page->og_title : 'nom-de-item' }}</span>
                                        </p>
