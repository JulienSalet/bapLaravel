...
<div class="login-wrapper">
    <div class="bg-pic">
        <img src="{{ asset('pages-assets/img/demo/new-york-city-buildings-sunrise-morning-hd-wallpaper.jpg') }}"
             data-src="{{ asset('pages-assets/img/demo/new-york-city-buildings-sunrise-morning-hd-wallpaper.jpg') }}"
             data-src-retina="{{ asset('pages-assets/img/demo/new-york-city-buildings-sunrise-morning-hd-wallpaper.jpg') }}"
             alt=""
             class="lazy">
    </div>
            ...
            <form class="p-t-15" action="{{ action('Admin\Auth\LoginController@login') }}"
                ...
                <div class="row">
                    <div class="col-md-6 no-padding sm-p-l-10">
                        <div class="checkbox">
                            <input type="checkbox" value="1" name="remember" {{ old('remember') ? 'checked' : '' }} id="checkbox1">
