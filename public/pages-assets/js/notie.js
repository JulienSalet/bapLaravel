...
var notie = function(){
    ...
    // General
    var shadow = true;
    var font_size_small = '1em';
    var font_size_big = '1em';
    ...
    var alert_color_warning_background = '#F17A30';
    var alert_color_error_background = '#fa424a';
    var alert_color_info_background = '#ac6bec';
    var alert_color_text = '#FFF';

    // notie.confirm colors
    var confirm_and_input_color_background = '#50C1D2';
    ...
    function alert_show(type, message, seconds) {
        ...
        // Get notie's height
        alert_outer.style.bottom = '-10000px';
        alert_outer.style.display = 'table';
        alert_outer.style.bottom = '-' + alert_outer.offsetHeight - 5 + 'px';
    ...
    confirm_background.style.bottom = '0';
    ...
    function confirm_show(title, yes_text, no_text, yes_callback) {
        ...
        function confirm_show_inner() {
            ...
            confirm_outer.style.bottom = '-10000px';
            confirm_outer.style.display = 'table';
            confirm_outer.style.bottom = '-' + confirm_outer.offsetHeight - 5 + 'px';
    ...
    function input_show(title, submit_text, cancel_text, submit_callback) {
        ...
        function input_show_inner() {
            ...
            // Get input's height
            input_outer.style.bottom = '-10000px';
            input_outer.style.display = 'table';
            input_outer.style.bottom = '-' + input_outer.offsetHeight - 5 + 'px';
